...
class BaseStaffingConfigCreateDto(BaseModel):
    ...
    factory_id: SnowflakeIdIn = Field(..., description="工厂ID")
    operation_id: SnowflakeIdIn = Field(..., description="工序ID")
    worker_type_id: SnowflakeIdIn = Field(..., description="工种ID")
...
class BaseStaffingConfigUpdateDto(BaseModel):
    ...
    factory_id: Optional[SnowflakeIdIn] = Field(default=None, description="工厂ID")
    operation_id: Optional[SnowflakeIdIn] = Field(default=None, description="工序ID")
    worker_type_id: Optional[SnowflakeIdIn] = Field(default=None, description="工种ID")
...
class BaseStaffingConfigQueryDto(PageRequest):
    ...
    worker_type_id: Optional[SnowflakeIdIn] = Field(default=None, description="工种ID过滤")
