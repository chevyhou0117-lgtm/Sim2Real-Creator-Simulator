...
export function LanguageToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1.5 text-[10px] font-medium text-slate-400 hover:text-slate-200 bg-[#0b1d30] hover:bg-[#142235] border border-[#1e3a55] hover:border-[#2a4a6a] rounded px-2.5 py-1 transition-colors ${className}`}
    >
      <Globe size={11} />
