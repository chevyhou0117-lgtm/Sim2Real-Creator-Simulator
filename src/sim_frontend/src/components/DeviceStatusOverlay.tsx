...
function DeviceStatusOverlayInner({
  ...
  if (!stat) {
    ...
    return (
      <div className="w-80 bg-[#0b1d30]/95 border border-[#1e3a55] rounded-xl shadow-2xl backdrop-blur-sm overflow-hidden">
  ...
  return (
    <div className="w-80 bg-[#0b1d30]/95 border border-[#1e3a55] rounded-xl shadow-2xl backdrop-blur-sm overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-2 px-4 pb-3">
        <div className="bg-[#07111e] rounded-lg py-2 text-center">
